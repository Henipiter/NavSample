    ...
    companion object {
        fun getProducts(): List<List<Product>> {
            return listOf(
                ...
                listOf(
                    Product(4, "IBUPROM 200MG 10 TABL", 2, 1.0, 8.24, 3.59, 0.0, 3.59, "D", ""),
                ),
                listOf(
        ...
        fun getReceipts(): List<Receipt> {
            return listOf(
                Receipt(1, 7.79, 0.0, "2024-09-22", "17:33"),
                Receipt(1, 28.11, 0.0, "2024-09-21", "18:30"),
                Receipt(2, 60.17, 7.69, "2024-09-22", "14:17"),
                Receipt(4, 12.24, 0.01, "2024-09-18", "19:54"),
                Receipt(5, 8.24, 0.59, "2024-08-18", "19:54"),
                Receipt(5, 98.24, 0.61, "2024-07-18", "19:54")
            )
        }
